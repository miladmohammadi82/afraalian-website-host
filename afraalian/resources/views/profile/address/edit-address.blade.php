...
<div class="d-flex justify-content-center">
    <div class="content-checkout-edit-addressPage">
        <div class="edit-box-header">
            <div class="">
                <h5>ویرایش جزئیات آدرس</h5>
            </div>
        </div>

        <div class="edit-box-body">
            <form action="{{ route('update.address.user.profile', $address->id) }}" method="post" id="send-info-checkout">
                @csrf
                <div class="form-group group col-lg-12 w-100  mt-4">
                    <input class="input-checkout-priduct-info w-100" value="{{ $address->fullname }}"
                        name="shopping_fullname" type="text" required>
                    <span class="bar"></span>
                ...
                <div class="form-group group col-lg-12 w-100  mt-4">
                    <input class="input-checkout-priduct-info w-100" value="{{ $address->address }}"
                        name="shopping_address" type="text" required>
                ...
                <div class="select-divs-addres mt-3">
                    <div class="form-group group col-lg-6 col-sm-12 col-md-12">
                        ...
                        <div class="search-select-box">
                            <select class="chosen-select-option" name="shopping_state" data-live-search="true">
                    ...
                    <div class="form-group group col-lg-6 col-sm-12 col-md-12">
                        ...
                        <div class="search-select-box">
                            <select class="chosen-select-option" name="shopping_city" id="" data-live-search="true">
                                <option value="1">گیلان</option>
                                <option value="2">تهران</option>
                                <option value="3">اهواز</option>
                                <option value="4">گلستان</option>
                ...
                <div class="form-group group col-lg-12 w-100  mt-4">
                    <input class="input-checkout-priduct-info w-100" value="{{ $address->zipcode }}"
                        name="shopping_zipcode" type="text" required>
                    <span class="bar w-100"></span>
                ...
                <div class="form-group group col-lg-12 w-100  mt-4">
                    <input class="input-checkout-priduct-info w-100" value="{{ $address->phone }}" name="shopping_phone"
                        type="text" required>
                    <span class="bar w-100"></span>
