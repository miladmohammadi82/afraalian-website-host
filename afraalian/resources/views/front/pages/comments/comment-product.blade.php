    ...
    <div class="product-comment">
        ...
        <div class="flex-grow-1 mt-4" style="padding-right: 10px">
                ...
                <div>
                    ...
                    <form action="{{ route('create.new.replay-product') }}" method="POST" class="reply-comment-article mt-4">
                        @csrf
            ...
            @include('front.pages.comments.comment-product', ['comments' => $comment->replies])
