            ...
            <div class="container">
                <div class="justify-content-center anime fade-in-y fast forgot row">
                    <div class="box-input-auth p-3 rounded col-9 col-sm-7 col-md-5 col-lg-4">
                        <div class="">
                            <form action="{{ route('createUser.admin.panel') }}" method="post">
                                @csrf
                                <div class="input-fild-box form-group">
                                    <label for="">نام</label>
                                    <input type="text" class="mt-2 form-control @error('name') is-invalid @enderror " placeholder="نام" value="{{old('name')}}"
                                        name="name" id="">
                                        @error('name')
                                ...
                                <div class="input-fild-box form-group">
                                    ...
                                    <input type="email" class="mt-2 form-control @error('email') is-invalid @enderror" placeholder="ایمیل" value="{{old('email')}}"
                                        name="email" id="">
                                        @error('email')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
                                ...
                                <div class="input-fild-box form-group">
                                    ...
                                    <input type="text" class="mt-2 form-control @error('phone') is-invalid @enderror" value="{{old('phone')}}"
                                ...
                                <div class="input-fild-box form-group">
                                    ...
                                    <input type="password" v-model="form.password" class="mt-2 form-control @error('password') is-invalid @enderror"
